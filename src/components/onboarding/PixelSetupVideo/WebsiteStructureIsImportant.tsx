...
const SEG_SOURCE: [string, string, number][] = [
  ...
  ["S2", "Your website structure should look like this:\n1. Website / Landing Page → 2. Booking or Checkout → 3. Thank-You Page", 5200],
  ["S3", "For example:\nSomeone visits your website.\nThen they go to your Booking or Checkout page.\nAfter they successfully complete the action, they are sent to a separate Thank-You Page.", 6200],
