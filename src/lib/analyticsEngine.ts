...
export interface ProcessedVideoRow extends VideoMetricsResult {
  video:    { id: string; thumbnail_url?: string; video_title?: string; campaign_id?: string | null; video_goal?: string[]; selected_lead_magnet_ids?: string[] | null; platform?: string | null; platform_url?: string | null; status?: string | null; created_at?: string | null };
